...
loop do
  ...
  def pass
    if @age >= 18 
      ...
      puts "Здравствуйте, #{@name} #{@surname}. Вам меньше 18 лет, но начать учиться программированию никогда не рано. Усердно учитесь и через #{@difference_age} #{gradient_age} когда Вам исполнится 18 лет, Вы сможете заняться делом."
    end
end
